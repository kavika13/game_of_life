...
const unsigned int FLASH_MESSAGE_CHARACTER_SIZE = 15 * DEVICE_PIXEL_RATIO;
...
const unsigned int VIRTUAL_RESOLUTION_WIDTH = 512;
const unsigned int VIRTUAL_RESOLUTION_HEIGHT = 384;
